...
@section('content')
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                    <div class="small-category-2">
                        <div class="small-category-2-thumb img-1">
                            <a href="properties-full-grid-1.html"><img src="Frontend/images/popular-places/5.jpeg"
                                                                       alt=""></a>
                        </div>
    ...
    <section id="property" class="featured portfolio bg-white-2 rec-pro full-l">
        <div class="container-fluid">
                <div class="sec-title">
                    ...
                    <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 landscapes sale">
                        <div class="project-single" data-aos="fade-right">
                            <div class="project-inner project-head">
                                <div class="homes">
                                    <!-- homes img -->
                                    <a href="{{ route('single-property', Crypt::encryptString($item->id)) }}" class="homes-img">
                                        <div class="homes-tag button alt featured">Featured</div>
                                        <div class="homes-tag button alt sale">For {{$item->status}}</div>
                                        <img src="Frontend/images/property/property.jpg" alt="home-1" class="img-responsive">
                                    </a>
                                </div>
                                <div class="button-effect">
                                    <a href="{{ route('single-property', Crypt::encryptString($item->id)) }}" class="btn"><i class="fa fa-link"></i></a>
                                    <a href="https://www.youtube.com/watch?v=14semTlwyUY"
                                       class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                    <a href="{{ route('single-property', Crypt::encryptString($item->id)) }}" class="img-poppu btn"><i
                            ...
                            <div class="homes-content">
                                <!-- homes address -->
                                <h3><a href="{{ route('single-property', Crypt::encryptString($item->id)) }}">{{$item->title}}</a></h3>
                                <p class="homes-address mb-3">
                                    <a href="{{ route('single-property', Crypt::encryptString($item->id)) }}">
                                ...
                                <ul class="homes-list clearfix pb-3">
                                    <li class="the-icons">
                                        ...
                                        <span>{{$item->extraInformation->bedroom}} Bedroom </span>
                                    </li>
                                    <li class="the-icons">
                                        <i class="fa-solid fa-toilet"></i>
                                        <span>{{$item->extraInformation->bathroom}} Bathrooms</span>
                                    </li>
                                    <li class="the-icons">
                                    ...
                                    <li class="the-icons">
                                        ...
                                        <span>{{$item->extraInformation->garage}} Garages</span>
                                    </li>
                                </ul>
                                <div class="price-properties footer pt-3 pb-0">
                                    <h3 class="title mt-3">
                                        <a href="{{ route('single-property', Crypt::encryptString($item->id)) }}">$ {{$item->price}}</a>
                                    </h3>
                                    <div class="compare">
        ...
        <div class="container-fluid">
            ...
            <div class="row service-1">
                ...
                <article class="col-lg-3 col-md-6 col-xs-12 serv mb-0 pt its-2" data-aos="fade-up"
                    ...
                    <div class="serv-flex">
                        <div class="art-1 img-14">
                            <img src="Frontend/images/icons/icon-15.svg" alt="">
                        ...
                        <div class="landscapes">
                            <div class="project-single">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-3.html" class="homes-img">
                                            ...
                                            <img src="Frontend/images/blog/b-11.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                ...
                                <div class="homes-content">
                                    ...
                                    <div class="price-properties footer pt-3 pb-0">
                                        <h3 class="title mt-3">
                                            <a href="single-property-3.html">$ 350,000</a>
                                        </h3>
                                        <div class="compare">
                                            <a href="#" title="Compare">
                        ...
                        <div class="people">
                            <div class="project-single">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-3.html" class="homes-img">
                                            ...
                                            <img src="Frontend/images/blog/b-12.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="single-property-3.html" class="btn"><i class="fa fa-link"></i></a>
                                ...
                                <div class="homes-content">
                                    ...
                                    <div class="price-properties footer pt-3 pb-0">
                                        <h3 class="title mt-3">
                                            <a href="single-property-3.html">$ 150,000</a>
                                        </h3>
                                        <div class="compare">
                                            <a href="#" title="Compare">
                                                <i class="flaticon-compare"></i>
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-3.html" class="homes-img">
                                            <div class="homes-tag button alt featured">Featured</div>
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="Frontend/images/feature-properties/fp-10.jpg" alt="home-1"
                            ...
                            <div class="project-single no-mb">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-3.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="Frontend/images/feature-properties/fp-11.jpg" alt="home-1"
                                                 class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                            ...
                            <div class="project-single no-mb last">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-3.html" class="homes-img">
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="Frontend/images/feature-properties/fp-12.jpg" alt="home-1"
                                                 class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
        ...
        <div class="container-fluid">
            ...
            <div class="row team-all">
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2" data-aos="fade-up" data-aos-delay="150">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="agents-listing-grid.html"><img src="Frontend/images/team/t-5.jpg" alt="" /></a>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2" data-aos="fade-up" data-aos-delay="250">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="agents-listing-grid.html"><img src="Frontend/images/team/t-6.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2" data-aos="fade-up" data-aos-delay="350">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="agents-listing-grid.html"><img src="Frontend/images/team/t-7.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 pb-none" data-aos="fade-up"
                    ...
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="agents-listing-grid.html"><img src="Frontend/images/team/t-8.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 pb-none" data-aos="fade-up"
                    ...
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="agents-listing-grid.html"><img src="Frontend/images/team/team-image-2.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 pb-none" data-aos="fade-up"
                    ...
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="agents-listing-grid.html"><img src="Frontend/images/team/team-image-7.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="owl-carousel job_clientSlide">
                <div class="singleJobClinet" data-aos="zoom-in" data-aos-delay="150">
                    ...
                    <div class="detailJC">
                        <span><img src="Frontend/images/testimonials/ts-1.jpg" alt="" /></span>
                        <h5>Lisa Smith</h5>
                        <p>New York</p>
                    </div>
                </div>
                <div class="singleJobClinet" data-aos="zoom-in" data-aos-delay="250">
                    ...
                    <div class="detailJC">
                        <span><img src="Frontend/images/testimonials/ts-2.jpg" alt="" /></span>
                        <h5>Jhon Morris</h5>
                        <p>Los Angeles</p>
                    </div>
                </div>
                <div class="singleJobClinet" data-aos="zoom-in" data-aos-delay="350">
                    ...
                    <div class="detailJC">
                        <span><img src="Frontend/images/testimonials/ts-3.jpg" alt="" /></span>
                        <h5>Mary Deshaw</h5>
                        <p>Chicago</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="Frontend/images/testimonials/ts-4.jpg" alt="" /></span>
                        <h5>Gary Steven</h5>
                        <p>Philadelphia</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="Frontend/images/testimonials/ts-5.jpg" alt="" /></span>
                        <h5>Cristy Mayer</h5>
                        <p>San Francisco</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="Frontend/images/testimonials/ts-6.jpg" alt="" /></span>
                        <h5>Ichiro Tasaka</h5>
                        <p>Houston</p>
                    </div>
                </div>
    ...
    <div class="partners bg-white rec-pro">
        <div class="container-fluid">
            ...
            <div class="owl-carousel style2">
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/11.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/12.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/13.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/14.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/15.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/16.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/17.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/11.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/12.jpg" alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="Frontend/images/partners/13.jpg" alt=""></div>
            </div>
