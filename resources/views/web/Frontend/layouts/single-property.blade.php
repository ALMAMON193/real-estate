            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 blog-pots">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner carus" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="images/slider/slider-1.jpg" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="images/slider/bg-h-1.jpeg" alt="Third slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="images/slider/b-1.jpeg" alt="Second slide">
                                    </div>
                                </div>
                    ...
                    <div class="property wprt-image-video w50 pro vid-si3">
                        ...
                        <img alt="image" src="images/slider/slider-1.jpg">
                            ...
                            <div class="widget-boxed-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 book">
                                        <input type="text" id="reservation-date" data-lang="en" data-large-mode="true" data-min-year="2017" data-max-year="2020"
                                               data-disabled-days="08/17/2017,08/18/2017" data-id="datedropper-0" data-theme="my-style" class="form-control" readonly>
                                    </div>
